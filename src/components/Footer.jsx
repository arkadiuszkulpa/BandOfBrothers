    ...
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Band of Brothers</h3>
            <p className="text-gray-400">
              Uniting men in their journey of self-improvement and spiritual growth.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Band of Brothers. A grassroots movement for men.</p>
        </div>
      </div>
    </footer>
  );
